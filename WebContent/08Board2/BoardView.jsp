...
<%
	/*
	    검색후 파라미터 처리를 위한 추가 부분
	    	: 리스트에서 검색후 상세보기, 그리고 다시 리스트보기를
	    	눌렀을때 검색이 유지되도록 처리하기 위한 코드삽입
	*/
	...
	//3페이지에서 상세보기했다면 리스트로 돌아갈때도 3페이지로 돌아가야한다.
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-9 pt-3">
				<h3>
					<%=boardTitle %> - <small>View(상세보기)</small>
				</h3>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class="align-middle" style="height: 200px;">
									...
									저장되므로, HTML 페이지에 출력할때는 <br/>태그로 문자열을
									변경해야한다.
									 --%> 
				...
				<div class="row mb-3">
					<div class="col-6">
						...
						<%
							/*
							로그인이 완료된 상태이면서, 동시에 해당게시물의 작성자라면
							수정, 삭제 버튼을 보이게 처리한다.
							*/
