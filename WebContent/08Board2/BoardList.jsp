...
<%@include file="../common/isFlag.jsp" %>
    ...
    //wed.xml에 저장된 컨텍스트 초기화 파라미터를 application객체를 통해 가져옴
    ...
    */
    ...
    String queryStr = "";//검색시 페이지 번호로 쿼리스트링을 넘겨주기 위한 용도
    ...
    //전체 페이지 수 계산 => 111 / 10 => 11.1 => ceil(11.1) => 12
    int totalPage = (int)Math.ceil((double)totalRecordCount/pageSize);
    /*
	    현재페이지 번호  : 파라미터가 없을때 무조건 1페이지 지정하고, 있을때 해당 값을
	   	 얻어와서 지정한다. 즉 리스트에 처음 진입했을떄는 1페이지가 된다.
    */
    int nowPage = (request.getParameter("nowPage")==null || 
    		request.getParameter("nowPage").equals(" "))
    		? 1 : Integer.parseInt(request.getParameter("nowPage"));
   
    //MariaDB를 통해 현재페이지에 출력할 게시물의 범위를 결정한다.
    //limit의 첫번째 인자 : 시작 인덱스
