<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String a1 = "", a2 = "", a3 = "", a4 = "";
    if(bname.indexOf("free")>=0){
    	a1 = "active";
    }
    else if(bname.indexOf("notice")>=0){
    	a2 = "active";
    }
    else if(bname.indexOf("qna")>=0){
    	a3 = "active";
    }
    else{
    	a4 = "active";
...
<div class="col-3">
			...
			<div class="nav flex-column nav-pills" id="v-pills-tab" 
				...
				<a class="nav-link <%=a1 %>" id="v-pills-home-tab" href="../08Board2/BoardList.jsp?bname=freeboard" 
				role="tab" aria-controls="v-pills-home" aria-selected="true">자유게시판</a>
				<a class="nav-link <%=a2 %>" id="v-pills-home-tab" href="../08Board2/BoardList.jsp?bname=notice" 
				role="tab" aria-controls="v-pills-home" aria-selected="true">공지사항</a>
				<a class="nav-link <%=a3 %>" id="v-pills-home-tab" href="../08Board2/BoardList.jsp?bname=qna" 
				role="tab" aria-controls="v-pills-home" aria-selected="true">질문과답변</a>
				<a class="nav-link <%=a4 %>" id="v-pills-home-tab" href="../08Board2/BoardList.jsp?bname=faq" 
